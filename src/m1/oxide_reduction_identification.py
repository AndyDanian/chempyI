...
def input_substance() -> tuple[str, int, str, int,
                               str, int, str, int]:
    """
...
def calculate_oxidation_number(
    molecule_composition: dict[str, int], oxidation_number: dict[str, int],
        charge: int) -> dict[str, int]:
    """
...
def oxide_reduction(
    ...
    """
    Find the oxidiz or reduction atoms
    """
